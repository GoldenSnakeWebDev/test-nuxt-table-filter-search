<template>
    <div class="card">
        <DataTable v-model="filters" :value="customers" paginator :rows="10" dataKey="id" filterDisplay="row" :loading="loading"
...
export default {
    ...
    data() {
        return {
            ...
            statuses:ref(['unqualified', 'qualified', 'new', 'negotiation', 'renewal', 'proposal']),
            loading: ref(true)
        }
    },
}
